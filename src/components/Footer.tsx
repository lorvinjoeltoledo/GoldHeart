          ...
          >
            ...
            <div className="space-y-2">
              <a
                ...
                className="block text-[var(--text-primary)] hover:text-[var(--gold)] transition-colors text-sm"
              >
          ...
          >
            ...
            <div className="flex gap-3 mt-6">
              {[
                ...
                {
                  name: "Google",
                  href: "https://share.google/sZb24ec9clauTfrXr",
